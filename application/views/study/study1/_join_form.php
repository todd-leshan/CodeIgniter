<div>
	<div id="form_title"> Join now, please fill in the form below</div>


	<?php echo form_open(base_url()."index.php/register_study1/")?>
	...
	<div>
		...
		<select name="country">
			...
			<option value="New Zealand" <?php echo set_select('country', 'New Zealand'); ?> >New Zealand</option>
			<option value="Britain" <?php echo set_select('country', 'Britain'); ?> >Britain</option>
			<option value="France" <?php echo set_select('country', 'France'); ?> >France</option>
			<option value="Japan" <?php echo set_select('country', 'Japan'); ?> >Japan</option>
