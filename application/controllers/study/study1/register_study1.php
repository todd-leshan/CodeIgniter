<?php
class Register_study1 extends CI_Controller 
{
	function __construct()
	{
		parent::__construct();
		$this->load->library(array('form_validation'));
		$this->load->model('study/study1/CI_captcha');
		$this->load->model('study/study1/CI_menu');
		$this->load->model('study/study1/CI_encrypt');
	...
	function index()
	{
		...
		$data['title'] = "Todd's Registration System";
	...
	//$this->form_validation->set_message('required', 'Your custom message here');
		...
		{
		$data['body']  = $this->load->view('study/study1/_join_form', $sub_data, true);
		}else
		{
